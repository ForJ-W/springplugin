 ...
 */
@Setter
public class AppComponentClassScanner extends ClassPathBeanDefinitionScanner {

    /**
     * log
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(AppComponentClassScanner.class);
     ...
     * @author afěi
     */
    public AppComponentClassScanner(BeanDefinitionRegistry registry) {
