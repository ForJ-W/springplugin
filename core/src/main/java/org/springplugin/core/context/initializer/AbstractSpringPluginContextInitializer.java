...
public abstract class AbstractSpringPluginContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
     ...
     */
    protected abstract void initialize(GenericApplicationContext context, PluginInfo pluginInfo);
}
