 ...
 * @version 1.0.0
 */
public class SpringPluginWebMvcConfigureInitializer extends AbstractSpringPluginContextInitializer implements ApplicationContextInitializer<AnnotationConfigApplicationContext>, Ordered {
